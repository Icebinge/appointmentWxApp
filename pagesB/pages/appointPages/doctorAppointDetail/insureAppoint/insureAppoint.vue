<template>
	<view>
		<view class="blue-column-border-box">
			...
			<view class="blue-text">预约信息详情</view>
		</view>
		<view class="gray-box">
<!-- 			<view class="top-row-box">
				<text class="left left-text">预约诊疗费</text>
				<text class="right right-text"><text style="color: #FFD39B;">10</text>元</text>
			</view> -->
			<view class="top-row-box">
				<text class="left left-text">地址</text>
...
<!-- 			<view class="top-row-box">
			...
			<view class="top-row-box">
				<text class="left left-text">预约时间</text>
		...
		<view class="blue-column-border-box" style="margin-top: 30rpx;">
			<view class="blue-border"></view>
			<view class="blue-text">选择预约卡人</view>
		</view>
		<view class="gray-box">
			<view class="bottom-row-box" @tap="showModal()" v-if="cardID">
				...
				<text class="right right-text">(预约卡号：{{cardID}})</text>
			</view>
			<view class="bottom-row-box" @tap="showModal()" v-else>
				<view class="left left-icon-text-box">
					<image class="icon" :src="iconURL + 'radio-actived.png'"></image>
					<text class="left-text">点击选择家人预约卡</text>
				</view>
				<text class="right right-text">(预约卡号：{{cardID}})</text>
			</view>
			<view class="bottom-row-box" @tap="getIsCardOverIimit()">
				<view class="left left-icon-text-box">
					...
					<text class="left-text">添加预约卡人</text>
				</view>
			</view>
		</view>
		...
		<view class="cu-modal" :class="showCardId?'show':''">
			<view class="cu-dialog">
				<view class="cu-bar bg-white justify-end">
					<view class="content">切换预约卡人</view>
